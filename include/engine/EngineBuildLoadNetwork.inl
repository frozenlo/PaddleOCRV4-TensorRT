...
template <typename T>
bool Engine<T>::buildLoadNetwork(const std::string& onnxModelPath, const std::array<float, 3> &subVals, const std::array<float, 3> &divVals,
                                 bool normalize) {
...
template <typename T>
bool Engine<T>::loadNetwork(const std::string& trtModelPath, const std::array<float, 3> &subVals, const std::array<float, 3> &divVals,
                            bool normalize) {
    m_subVals = subVals;
    m_divVals = divVals;
